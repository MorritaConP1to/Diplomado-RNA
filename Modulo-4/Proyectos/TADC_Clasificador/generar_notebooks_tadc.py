#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Genera CNN_Multiclase.ipynb y Transfer_Learning_Multiclase.ipynb con estilo biclase."""
import json, os
...
VERSION = 'v2'  # Incrementa al regenerar (v2, v3, ...)
...
print('=' * 60)
print('BATERIA DE EXPERIMENTOS: %d variantes' % len(experimentos_plan))
print('Cada una usa early stopping (patience=%d) con max %d epocas.' % (
    CONFIG['PATIENCE'], CONFIG['EPOCHS']))
print('Esto tomara varios minutos (~30-60 seg por experimento).')
print('=' * 60)
...
# ============================================================
# ENSAMBLAR NOTEBOOK 1: CNN_Multiclase.ipynb
# ============================================================
...
cnn_cells = [
    ...
    code_cell("NOMBRE_MODELO = 'cnn_multiclase'; " + shared_code_guardar['source'][0]),
    shared_code_footer,
]
...
print('Modelo CNN desde cero guardado.')
print('Clases:', clases)
""")
...
out_1 = os.path.join(BASE, 'CNN_Multiclase{}.ipynb'.format(SUFIJO))
...
# ============================================================
# ENSAMBLAR NOTEBOOK 2: Transfer_Learning_Multiclase.ipynb
# ============================================================
...
out_2 = os.path.join(BASE, 'Transfer_Learning_Multiclase{}.ipynb'.format(SUFIJO))
